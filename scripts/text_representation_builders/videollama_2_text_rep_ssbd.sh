...
#SBATCH --job-name=videollama_2_text_rep_x_ssbd       #Set the job name to "JobExample4"
...
#SBATCH --output=videollama_2_text_rep_x_ssbd_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python videollama_2_text_rep_x_ssbd.py > ../logs/videollama_2_text_rep_x_ssbd.txt
