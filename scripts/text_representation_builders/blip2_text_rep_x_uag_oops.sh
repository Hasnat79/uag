...
#SBATCH --job-name=blip2_text_rep_x_uag_oops       #Set the job name to "JobExample4"
...
#SBATCH --output=blip2_text_rep_x_uag_oops_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python blip2_text_rep_x_uag_oops.py > ../logs/blip2_text_rep_x_uag_oops.txt
