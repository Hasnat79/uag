...
from configs.configure import finetuned_videollama_pred_x_ssbd_dataset_path
...
if __name__ == "__main__":
    ...
    results = {}
    if os.path.exists(finetuned_videollama_pred_x_ssbd_dataset_path):
        with open(finetuned_videollama_pred_x_ssbd_dataset_path, "r") as f:
            results = json.load(f)
    ...
    for video_id,video_info in tqdm(ssbd_data):
        ...
        if video_id not in results:
            ...
            try:
                ...
                print(e)
            # save results
            with open(finetuned_videollama_pred_x_ssbd_dataset_path, "w") as f:
                json.dump(results, f, indent=4)
                print(f"Results saved successfully in {finetuned_videollama_pred_x_ssbd_dataset_path}")
