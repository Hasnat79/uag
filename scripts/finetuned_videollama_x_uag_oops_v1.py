...
from configs.configure import uag_oops_dataset_path, finetuned_videollama_pred_x_uag_oops_dataset_path
...
if __name__ == "__main__":
    ...
    result = {}
    if os.path.exists(finetuned_videollama_pred_x_uag_oops_dataset_path):
        with open(finetuned_videollama_pred_x_uag_oops_dataset_path, "r") as f:
            result = json.load(f)
    ...
    for video_id, video_info in tqdm(uag_oops_v1):
        if video_id not in result:
            ...
            try:
                ...
                print(e)
            with open(finetuned_videollama_pred_x_uag_oops_dataset_path, "w") as f:
                json.dump(result, f, indent=4)
                print(f"Results saved successfully in {finetuned_videollama_pred_x_uag_oops_dataset_path}")
    # check the results
