...
#SBATCH --job-name=video_llama2_ssbd_job       #Set the job name to "JobExample4"
...
#SBATCH --output=video_llama2_ssbd_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python video_llama2_x_ssbd.py > logs/video_llama2_ssbd.txt