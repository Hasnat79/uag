...
import json
from configs.configure import blip2_text_rep_x_oops_dataset_v1_path, llama3_pred_x_blip2_text_rep_x_uag_oops_dataset_v1_path,llama3_model_id
...
if __name__ == "__main__":
    ...
    results = {}
    if os.path.exists(llama3_pred_x_blip2_text_rep_x_uag_oops_dataset_v1_path):
      with open(llama3_pred_x_blip2_text_rep_x_uag_oops_dataset_v1_path, 'r') as f:
          results = json.load(f)
