...
#SBATCH --job-name=finetuned_videollama_x_ssbd_job       #Set the job name to "JobExample4"
...
#SBATCH --output=finetuned_videollama_x_ssbd_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python finetuned_videollama_x_ssbd.py > logs/finetuned_videollama_x_ssbd.txt
