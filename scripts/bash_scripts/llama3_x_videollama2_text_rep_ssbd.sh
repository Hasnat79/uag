...
#SBATCH --job-name=llama3_x_videollama2_text_rep_x_ssbd       #Set the job name to "JobExample4"
...
#SBATCH --output=llama3_x_videollama2_text_rep_x_ssbd_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python llama3_x_videollama2_text_rep_ssbd.py > logs/llama3_x_videollama2_text_rep_x_ssbd_run3_prmpt3.txt
