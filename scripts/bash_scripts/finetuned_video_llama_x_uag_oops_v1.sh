...
#SBATCH --job-name=finetuned_videollama_x_uag_oops_v1_job       #Set the job name to "JobExample4"
...
#SBATCH --output=finetuned_videollama_x_uag_oops_v1_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python finetuned_videollama_x_uag_oops_v1.py  > logs/finetuned_videollama_x_uag_oops_v1.py.txt
