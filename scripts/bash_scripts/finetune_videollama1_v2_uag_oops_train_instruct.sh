...
#SBATCH --job-name=finetune_videollama1_v2_oops_instruct       #Set the job name to "JobExample4"
...
#SBATCH --output=finetune_videollama1_v2_oops_instruct_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
torchrun --nproc_per_node=1 train.py --cfg-path  ./train_configs/visionbranch_stage2_finetune.yaml > logs/finetune_videollama1_v2_oops_instruct_run_1_for_cuda_mem.txt
