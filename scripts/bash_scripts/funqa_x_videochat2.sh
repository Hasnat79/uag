...
#SBATCH --job-name=funqa_x_videochat2_job       #Set the job name to "JobExample4"
...
#SBATCH --output=funqa_x_videochat2_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python funqa_x_videochat2.py  > logs/funqa_x_videochat2.txt
