...
#SBATCH --job-name=vidcht2_uag_oops_job       #Set the job name to "JobExample4"
...
#SBATCH --output=video_chatgpt_uag_oops_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python video_chatgpt_x_uag_oops_v1.py > logs/video_chatgpt_uag_oops.txt