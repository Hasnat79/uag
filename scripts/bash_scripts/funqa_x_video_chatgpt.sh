...
#SBATCH --job-name=funqa_x_video_chatgpt_job       #Set the job name to "JobExample4"
...
#SBATCH --output=funqa_x_video_chatgpt_Out.%j      #Send stdout/err to "Example4Out.[jobID]"
...
python funqa_x_video_chatgpt.py  > logs/funqa_x_video_chatgpt.txt
